    ...
    >
      ...
      <DropDown
        ...
        items={[
          ...
          { id: 'تاریخ', text: 'تاریخ' },
          { id: 'ساعت', text: 'ساعت' },
          { id: 'تاریخ و زمان', text: 'تاریخ و زمان' },
          { id: 'رمز', text: 'رمز' },
          { id: 'عدد', text: 'عدد' },
        ]}
      />

      <PresentationLabel text="آپلود فایل" />
      <File size="2.38MB" name="Example.pdf" onDownload={console.log} />
      <File
        size="9.8KB"
        name="سنمیالنسایلنماسینملانمسیالنماسیمکنلامنسیالنماسنمکیلا.pdf"
        onDownload={console.log}
      />
      <PresentationLabel text="منو باز شو تک انتخابی" />
      <Text text="گزینه انتخابی" />

      <PresentationLabel text="منو باز شو تک انتخابی" />
      <Text text={['گزینه اول انتخابی', 'گزینه دوم انتخابی'].join('\n')} />

      <PresentationLabel text="چند گزینه‌ای" />
      <Text text="گزینه انتخابی" />

      <PresentationLabel text="ورودی تک خطی (اختیاری)" />
      <Text text="متن ورودی" />

      <PresentationLabel text="ورودی چند خطی" />
      <Text text="لورم ایپسوم متن ساختگی با تولید سادگی نامفهوم از صنعت چاپ و با استفاده از طراحان گرافیک است. چاپگرها و متون بلکه روزنامه و مجله در ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای متنوع با هدف بهبود ابزارهای کاربردی می باشد. کتابهای زیادی در شصت و سه درصد گذشته، حال و آینده شناخت فراوان جامعه و متخصصان را می طلبد تا با نرم افزارها شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو در زبان فارسی ایجاد کرد. در این صورت می توان امید داشت که تمام و دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز شامل حروفچینی دستاوردهای اصلی و جوابگوی سوالات پیوسته اهل دنیای موجود طراحی اساسا مورد استفاده قرار گیرد." />

      <PresentationLabel text="انتخاب رنگ" />
      <Color backgroundColor="#4FC4F4" />

      <Header text="این یک عنوان است" />
